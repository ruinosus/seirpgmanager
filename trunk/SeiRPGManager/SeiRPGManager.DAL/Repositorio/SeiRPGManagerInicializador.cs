...
{
    public class SeiRPGManagerInicializador : DropCreateDatabaseIfModelChanges<SeiRPGManagerContexto>
    {
        protected override void Seed(SeiRPGManagerContexto context)
        {
